    ...
    (function() {{
        ...
        if (container) {{
            ...
            btn.onclick = function() {{
                var dataset = 'beaverses';
                var reservoirId = '{ID}';
                var fileUrl = 'https://raw.githubusercontent.com/casadoj/of_camels_and_beavers/v2.0/docs/timeseries/reservoirs/' + dataset + '_' + reservoirId + '.parquet';
                
                var a = document.createElement('a');
                a.href = fileUrl;
                a.download = dataset + '_' + reservoirId + '.parquet';
