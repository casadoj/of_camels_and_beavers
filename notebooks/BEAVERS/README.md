...
* [_beavers_4_website_](./beavers_4_website.ipynb) loads all the time series (observed reservoir operations and meteorology) and produces the HTML plots shown in the [GitHub Pages](https://casadoj.github.io/of_camels_and_beavers/).
